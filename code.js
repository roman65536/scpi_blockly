Blockly.Lua['block_scpi_init'] = function(block) {
  ...
  //var code = 'lxit_connect(' + value_name + ' ,5025,"ints0",2000,"RAW" )\n';
  var code = 'lxi_connect(' + value_name + ' ,5025,"ints0",2000,"RAW" )\n';
...
Blockly.Lua['block_scpi_command_noout'] = function(block) {
  ...
  // TODO: Assemble Lua into code variable.
  //var code = 'lxit_scpi(' +value_connection + ',' + value_command+ ') \n';
  var code = 'lxi_scpi(' +value_connection + ',' + value_command+ ') \n';
  return code;
};
...
Blockly.Lua['block_scpi_psu_on_off'] = function(block) {
  ...
  // TODO: Assemble Lua into code variable.
  var code = 'lxi_scpi('+value_connection+' , "INST ' + dropdown_output +'")\nlxit_scpi(' + value_connection + ', "OUTP:SEL ' + dropdown_on_off + '")\n';
  //var code = 'lxit_scpi('+value_connection+' , "INST ' + dropdown_output +'")\nlxit_scpi(' + value_connection + ', "OUTP:SEL ' + dropdown_on_off + '")\n';
  return code
};
...
Blockly.Lua['block_scpi_psu_volt'] = function(block) {
  ...
  // TODO: Assemble Lua into code variable.
  //var code = 'lxit_scpi(' +value_connection + ',string.format( "VOLT %.3f\\n",' + value_command+ ')) \nsleep(.2)\n';
  var code = 'lxi_scpi(' +value_connection + ',string.format( "VOLT %.3f\\n",' + value_command+ ')) \nsleep(.2)\n';
  return code;
};
...
Blockly.Lua['block_scpi_psu_curr'] = function(block) {
  ...
  // TODO: Assemble Lua into code variable.
  //var code = 'lxit_scpi(' +value_connection + ',string.format( "CURR %.3f\\n",' + value_command+ ')) \nsleep(.2)\n';
  var code = 'lxi_scpi(' +value_connection + ',string.format( "CURR %.3f\\n",' + value_command+ ')) \nsleep(.2)\n';
  return code;
};
...
Blockly.Lua['block_scpi_psu_gen_on_off'] = function(block) {
  ...
  var dropdown_on_off = block.getFieldValue('ON/OFF');
  // TODO: Assemble Lua into code variable.
  //var code = 'lxit_scpi('+value_connection+' ,  "OUTP:GEN ' + dropdown_on_off + '")\n';
  var code = 'lxi_scpi('+value_connection+' ,  "OUTP:GEN ' + dropdown_on_off + '")\n';
  return code
};
...
Blockly.Lua['block_scpi_psu_ask_volt'] = function(block) {
  ...
  var code = 'tonumber(lxi_scpi(' + value_connection + ', "MEAS:VOLT?"))\n';
  // TODO: Change ORDER_NONE to the correct strength.
  return [code, Blockly.Lua.ORDER_NONE];
};
...
Blockly.Lua['block_scpi_psu_ask_cur'] = function(block) {
  var value_connection = Blockly.Lua.valueToCode(block, 'connection', Blockly.Lua.ORDER_ATOMIC);
  // TODO: Assemble Lua into code variable.
  //var code = 'tonumber(lxit_scpi(' + value_connection + ', "MEAS:CURR?"))\n';
  var code = 'tonumber(lxi_scpi(' + value_connection + ', "MEAS:CURR?"))\n';
  // TODO: Change ORDER_NONE to the correct strength.
  return [code, Blockly.Lua.ORDER_NONE];
};
...
Blockly.Lua['block_scpi_command_msg'] = function(block) {
  ...
  // TODO: Assemble Lua into code variable.
  //var code = 'lxit_scpi(' +value_connection + ',string.format("DISP:WIND:TEXT:DATA \\"%s\\" ",'+ value_message + ')) \n';
  var code = 'lxi_scpi(' +value_connection + ',string.format("DISP:WIND:TEXT:DATA \\"%s\\" ",'+ value_message + ')) \n';
  return code;
};
...
Blockly.Lua['delay_os'] = function(block) {
